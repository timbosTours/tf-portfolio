    ...
    return (<>
        <footer className="h-96 w-screen bg-zinc-900">
            <nav className={`${roboto.className} pt-5 flex flex-col text-center`}>
                <Link
                    href={'/'}
                    className="my-5 text-amber-100 dark:text-columbiaBlue-700 md:text-lg">Home
                </Link>
                <Link
                    href="/#projects-section" className="my-5 text-amber-100 dark:text-columbiaBlue-700 md:text-lg">Projects
                </Link> 
                <Link
                    href="/#about-section" className="my-5 text-amber-100 dark:text-columbiaBlue-700 md:text-lg" >About
                </Link>
                <Link
                    href={'/contact'} className="my-5 text-amber-100 dark:text-columbiaBlue-700 md:text-lg">Contact
                </Link>
            </nav>
